...
# crate). Fixtures live at test/conformance/fixtures/cbor/native.toml; regenerate
# via `cd test/conformance/fixtures/cbor/gen && cargo run > ../native.toml`.
...
const _FIXTURE_FILE = joinpath(@__DIR__, "..", "..", "conformance", "fixtures", "cbor", "native.toml")

# label → Julia value the test encodes. Names match the labels emitted
# by test/conformance/fixtures/cbor/gen/src/main.rs.
const _CASES = Dict{String, Any}(
    ...
    # L3 typed — TAG_CUSTOM_DURATION (14)
