...
export EmbeddedFFIError, ConnectionUnavailableError, MissingNamespaceDatabaseError, UnsupportedEngineError, UnsupportedFeatureError, UnsupportedVersionError, UnexpectedResponseError
